...
% SLR_C20_tmonth(164) = 6;
% SLR_C20_tmonth(163) = 999;
% % replacement
% id = 0;
% for i = 1:length(GRACE_tyear)
...
%     GRACE_new(i).clm = GRACE(i).data;
% end                                


%% GRACE data
GRACE = GRACE_2002_2022;
GRACE_tyear = cell2mat({GRACE.year})';
GRACE_tmonth = cell2mat({GRACE.month})';
